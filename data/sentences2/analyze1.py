#!/usr/bin/python
#This script counts each domain name in the outputs4 directory and writes the output to stdout in the format that is read by the search and jsonconvert scripts
...
files = os.listdir("outputs4")
domains = {}
for i in files:
    currfile = open("outputs4/" + i, "r")
