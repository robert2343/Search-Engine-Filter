#!/usr/bin/python
#This script finds random phrases from the site https://randomwordgenerator.com/phrase.php and outputs them to the file phrases.txt.

from selenium import webdriver
from selenium.webdriver.common.keys import Keys
import os

outfile = open("phrases.txt", "w")
maxloops = 100
for i in range(maxloops):
    ...
    browser.get("https://randomwordgenerator.com/phrase.php")
