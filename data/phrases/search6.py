#!/usr/bin/python
#This script searches each line of phrasesunique.txt on the internet, using a locally run searx instance, and outputs a file for each search containing the links from that search.
#This requires Bueatiful Soup 4, and urllib to be installed

import urllib.request, urllib.error, urllib.parse
from bs4 import BeautifulSoup

searchfile = open("phrasesunique.txt", "r")
